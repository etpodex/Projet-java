...
public class LesFilmsVue extends JPanel {
    ...
    private MasterVue masterVue; // Référence à MasterVue

    public LesFilmsVue(int barre_navigation_panel_width, int frame_height, MasterVue masterVue) {
        this.masterVue = masterVue; // Initialisation de la référence à MasterVue
        ...
        for (int i = 0; i < nombre_de_film; i++) {
            Films film_panel = new Films(barre_navigation_panel_width * 2 / 3, 200, films[i], masterVue); // Passer la référence à MasterVue
