...
public class ChartModel {
    ...
    private void createPieDataset() {
        ...
        pieDataset.setValue("Catégorie 1", 43.2);
        pieDataset.setValue("Catégorie 2", 27.9);
        pieDataset.setValue("Catégorie 3", 79.5);
    }
    ...
    private void createBarDataset() {
        ...
        // Ajouter des valeurs à l'ensemble de données
        barDataset.addValue(1.0, "Ligne 1", "Colonne 1");
        barDataset.addValue(5.0, "Ligne 1", "Colonne 2");
        barDataset.addValue(3.0, "Ligne 1", "Colonne 3");
    }
